    ...
    <body>
                ...
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-1">
                        <div class="login-form"><!--login form-->
                            <top>
                                <form method="POST" action="RecomendadorSrv">
                                <h4>PERFIL CLIENTE</h4>
                                    ...
                                    <datalist id="clientes">
                                        ...
                                        <option value="HOGARES">
                                    </datalist>
                                
                                <h4>TIPO PC</h4>
                                    <input list="equipos" name="equipo" id="equipo">
                                    <datalist id="equipos">
                                        <option value="PORTATIL">
                                        <option value="ESCRITORIO">
                                        <option value="TODO EN UNO">
                                        <option value="HIBRIDO">
                                    </datalist>
                              
                                <h4>PERFIL PC</h4>
                                    <input list="usos" name="uso" id="uso">
                                    <datalist id="usos">
                                    ...
                                    <hr>
                                    <input type="submit" name="BtnRecomendador" value="Buscar">
                                </form>
        ...
        <div class="login-form"><!--login form-->
            <table class="table table-condensed">
                <thead>
                    <tr class="cart_menu">
                        <td class="total">MODELO</td>
                        <td class="total">PERFIL EQUIPO</td>
                        <td class="total">TIPO EQUIPO</td>
                        <td class="total">PERFIL CLIENTE</td>
                        <td class="total">CARACTERISTICAS</td>
