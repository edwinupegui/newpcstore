                                ...
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    ...
                                    <!---<li class="dropdown"><a href="#">TIENDA<i class="fa fa-angle-down"></i></a>
                                        <ul role="menu" class="sub-menu">
                                            <li><a href="shop.jsp">Computadores</a></li>
                                            <li><a href="product-details.jsp">Perifericos</a></li> 
            ...
            <div class="container">
                <div class="breadcrumbs">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">NewPCStore Admin Pedidos</li>
                    </ol>
                </div>
                <div class="table-responsive cart_info">

                    
                    <form method="POST" action="AdminPedidos">
                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            <%ArrayList<Pedido> datos=(ArrayList<Pedido>)request.getAttribute("datos");%>
                           
                            <c:forEach var="dato" items="${datos}">
                                <tr> 
                                    <td>${dato.id_pedido}</td>
                                    <td>${dato.getUsuario_id()}</td>
                                    <td>${dato.getProducto_id()}</td>
                                    <td>${dato.getCantidad()}</td>
                                    <td>${dato.getPrecio()}</td>
                                    <td>
                                        <form action="AdminPedidos" method="post">
